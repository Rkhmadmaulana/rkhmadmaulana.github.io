        ...
        <div class="flex flex-wrap -mx-4">
            <div class="w-full lg:w-5/12 px-4">
                <div class="hero-content">
                    <h1
                        class="text-dark dark:text-gray-200 font-bold text-4xl sm:text-[48px] lg:text-[46px] xl:text-[48px] leading-snug mb-6 ">
                        <!-- Nama Saya Rakhmad Maulana, <br /> -->
                        Nama Saya <span class="rounded-md text-amber-600">Rakhmad Maulana.</span>
                    </h1>
                    <p class="text-base mb-8 max-w-[520px]">
                        Saya Seorang Fresh Graduate. <br />
                        Saya ingin sharing tentang project saya.
                        <!-- <a class="text-primary font-bold no-underline hover:underline underline-offset-2 decoration-2 decoration-primary"
                            href="https://github.com/Rkhmadmaulana" target="_blank">GitHub</a> <br> -->
                    </p>
                    <ul class="flex flex-wrap items-center">
                        <li>
                            <x-button-link href="https://github.com/Rkhmadmaulana" variant="primary" class="rounded-lg">
                                Project Saya
                            </x-button-link>
                        </li>
                    </ul>

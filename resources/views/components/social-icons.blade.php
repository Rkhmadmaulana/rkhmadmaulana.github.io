<div {{ $attributes->class(['flex items-center']) }}>
    <a href="https://www.facebook.com/maulana.madridista.50" target="_blank" class="
                     w-10
                     h-10
                     flex
                     items-center
    ...
    <a href="https://www.instagram.com/rkhmadmaulana" target="_blank" class="
                     w-10
                     h-10
                     flex
                     items-center
    ...
    <a href="https://youtube.com/channel/UCUJh4xY5Fww5fiA-1DyiT8g" target="_blank" class="
                     w-10
                     h-10
                     flex
                     items-center
    ...
    <a href="https://www.linkedin.com/in/rakhmad-maulana-46288022a" target="_blank" class="
                     w-10
                     h-10
                     flex
                     items-center
